  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.5.5"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Color fields now keep keyboard focus while typing or editing hex. The color preview updates as you type, and the value is normalized when editing finishes."),
      ),
      React.createElement(RN.View, { style: card },
