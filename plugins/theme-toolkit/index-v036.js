(() => {
  ...
  function trailCount(trail) {
    if (trail === "short") return 10;
    if (trail === "long") return 30;
    return 18;
  }
  ...
  function Settings() {
    ...
    function OutlineCard({ stateName, prefix }) {
      ...
      return React.createElement(RN.View, { style: card },
        ...
        React.createElement(RN.Text, { style: text }, "Chase = one smooth glowing orb with a fading tail. Marquee = moving bright border sections."),
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.3.6"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Chase trail presets are now calibrated to roughly 25% / 50% / 85% of the folder perimeter for Short / Medium / Long."),
      ),
      React.createElement(RN.View, { style: card },
