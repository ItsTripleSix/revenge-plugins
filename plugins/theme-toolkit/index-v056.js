  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        ...
        React.createElement(RN.Text, { style: text }, "Mentioned messages can now use automatic black/white body-text contrast against the chosen highlight background. Inline @mention tag styling remains independent."),
      ),
      React.createElement(RN.View, { style: card },
