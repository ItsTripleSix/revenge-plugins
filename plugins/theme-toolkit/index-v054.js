  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.5.4"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "All manual color fields now include a tappable color swatch plus an editable hex field. Picker selections write the hex value back into the field; 8-digit alpha values keep their existing alpha when RGB is changed with the picker."),
      ),
      React.createElement(RN.View, { style: card },
