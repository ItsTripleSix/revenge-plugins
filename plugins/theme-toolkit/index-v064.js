(() => {
  ...
  function sourceMatchesAny(source, ids) {
  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.6.4 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Broader icon pass: colors Search/Settings at shared action/header renderers instead of chasing screens, and draws the selected-server pill directly at the guild wrapper."),
      ),
      React.createElement(RN.View, { style: card },
