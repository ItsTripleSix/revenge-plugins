(() => {
  ...
  function profileSummary(profile) {
    ...
    return `UI Toolkit • Search ${search} • Reaction ${reaction} • Mentions ${sourceLabel(mentionSource)}`;
  }
  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.7.2 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Generate a coordinated palette from one color, save the complete Toolkit appearance as a named profile, then restore it with a confirmed Discord reload."),
      ),
      React.createElement(RN.View, { style: card },
