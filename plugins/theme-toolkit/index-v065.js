      ...
      return after("default", GuildBarWrapperModule, (args, result) => {
        try {
          ...
          const overlay = React.createElement(RN.View, {
            ...
            pointerEvents: "none",
            style: {
              position: "absolute", left: -5, top: 7, width: 10, height: 42,
              borderRadius: 5, backgroundColor: color, zIndex: 999,
            },
          });
      ...
      return after("renderUnreadIndicator", GuildBarWrapperModule, (args, result) => {
        try {
          ...
          const overlay = React.createElement(RN.View, {
            ...
            pointerEvents: "none",
            style: {
              position: "absolute", top: 7, left: -5, width: 10, height: 42,
              borderRadius: 5, backgroundColor: color, zIndex: 50,
            },
          });
  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.6.5 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Verified accent batch: exact Search/Home/Settings assets are tinted at their final image renderers, and the selected-server pill covers Discord's white anti-aliased edge."),
      ),
      React.createElement(RN.View, { style: card },
