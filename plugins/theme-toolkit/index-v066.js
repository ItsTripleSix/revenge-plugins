(() => {
  ...
  function selectedGuildOverlay(color, key, top) {
    return React.createElement(RN.View, {
      ...
      pointerEvents: "none",
      style: {
        position: "absolute", left: -5, top, width: 10, height: 42,
        borderRadius: 5, backgroundColor: color, zIndex: 999, elevation: 999,
      },
    });
  }
      ...
      return after("default", GuildBarWrapperModule, (args, result) => {
        try {
          ...
          for (let rootIndex = 0; rootIndex < rootChildren.length; rootIndex++) {
            ...
            hostChildren.push(selectedGuildOverlay(color, "tt-selected-guild-host-overlay", 3));
          ...
          rootChildren.push(selectedGuildOverlay(color, "tt-selected-guild-fallback-overlay", 9));
      ...
      return after("renderUnreadIndicator", GuildBarWrapperModule, (args, result) => {
        try {
          ...
          const overlay = React.createElement(RN.View, {
            ...
            pointerEvents: "none",
            style: {
              position: "absolute", top: 3, left: -5, width: 10, height: 42,
              borderRadius: 5, backgroundColor: color, zIndex: 999, elevation: 999,
            },
          });
  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.6.6 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Direct-path verification: shared IconButton assets, the captured server Search renderer, and the selected-indicator host subtree are patched where Discord actually renders them."),
      ),
      React.createElement(RN.View, { style: card },
