  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.4.0"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Animation work now pauses while Discord is backgrounded and when Toolkit folder visuals are not mounted, then resynchronizes to the shared phase when visible again. Dynamic color updates are also reduced from 110 ms to 150 ms to lower JS wakeups without changing native motion."),
      ),
      React.createElement(RN.View, { style: card },
