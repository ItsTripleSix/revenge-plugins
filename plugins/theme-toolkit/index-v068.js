  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.6.8 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Batch verification: Discord's shared unread/selected server indicator renderer is replaced directly at its native 8×8 and 8×40 sizes; no white indicator remains underneath."),
      ),
      React.createElement(RN.View, { style: card },
