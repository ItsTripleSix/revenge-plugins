  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.6.2 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Third-pass visual test: fixes icon color type handling, targets the actual DM/Home Chat icon, and overlays the selected-server indicator directly."),
      ),
      React.createElement(RN.View, { style: card },
