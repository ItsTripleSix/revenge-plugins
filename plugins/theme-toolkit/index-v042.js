  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.4.2"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Collapsed Chase now treats Solid and Dotted as genuinely different patterns: Solid uses a dense overlapping uniform-width ribbon, while Dotted uses a much smaller number of separated round points. Background pause/resume remains enabled."),
      ),
      React.createElement(RN.View, { style: card },
