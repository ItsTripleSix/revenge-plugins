  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.6.3 TEST"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Fourth-pass visual test: targets the channel-list Search icon, colors the actual guild indicator style, and forces the reacted-reaction native theme even when Discord leaves it null."),
      ),
      React.createElement(RN.View, { style: card },
