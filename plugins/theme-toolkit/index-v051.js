  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.5.1"),
        React.createElement(RN.Text, { style: text }, activeThemeText),
        React.createElement(RN.Text, { style: text }, "Mention highlights now support animated color modes and attention effects. Animation only refreshes while an actual mentioned message is being rendered, then idles automatically when no mention is visible."),
      ),
      React.createElement(RN.View, { style: card },
