(() => {
  ...
  function parseProfileBackup(text) {
    ...
    const profiles = parsed.profiles.slice(0, 100)
      .flatMap((profile, index) => sanitizeProfileRecord(profile, `import-${index}`) ?? []);
  ...
  function Settings() {
    ...
    return React.createElement(RN.ScrollView, { contentContainerStyle: page },
      React.createElement(RN.View, { style: card },
        React.createElement(RN.Text, { style: title }, "Theme Toolkit v0.9.0 TEST"),
